...
public final class BigRational extends Number implements Comparable<BigRational> {
  ...
  public BigInteger ceil() {
    return Util.divideFloor(num.add(den.subtract(BigInteger.ONE)), den);
  }
  ...
  public BigRational divideEuclidean(BigRational b) {
    return new BigRational(Util.divideEuclidean(num.multiply(b.den), den.multiply(b.num)));
  }

  public BigRational divideFloor(BigRational b) {
    return new BigRational(Util.divideFloor(num.multiply(b.den), den.multiply(b.num)));
  }
  ...
  public BigInteger floor() {
    return Util.divideFloor(num, den);
  }
  ...
  public BigRational remainderEuclidean(BigRational b) {
    return new BigRational(Util.remainderEuclidean(num.multiply(b.den), den.multiply(b.num)));
  }

  public BigRational remainderFloor(BigRational b) {
    return new BigRational(Util.remainderFloor(num.multiply(b.den), den.multiply(b.num)));
  }
