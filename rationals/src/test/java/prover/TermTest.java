...
public class TermTest {
    ...
    public void deepGet() {
        ...
        assertEquals(Term.of(Term.ADD, Term.of(1.0), Term.of(2.0)).deepGet(0), Term.of(Term.ADD, Term.of(1.0), Term.of(2.0)));
    ...
    public void deepSplice() {
        ...
        assertEquals(Term.of(Term.ADD, Term.of(1.0), Term.of(2.0)).deepSplice(0, Term.of(9.0)), Term.of(9.0));
        assertEquals(Term.of(Term.ADD, Term.of(1.0), Term.of(2.0)).deepSplice(1, Term.of(9.0)),
                     Term.of(Term.ADD, Term.of(9.0), Term.of(2.0)));
        assertEquals(Term.of(Term.ADD, Term.of(1.0), Term.of(2.0)).deepSplice(2, Term.of(9.0)),
    ...
    public void eval() {
        ...
        assertEquals(Term.of(1).add(Term.of(2)).eval(map), Term.of(3));
        assertEquals(Term.of(1).add(Term.of(BigRational.of("2/1"))).eval(map), Term.of(BigRational.of("3/1")));
        assertEquals(Term.of(BigRational.of("1/1")).add(Term.of(2)).eval(map), Term.of(BigRational.of("3/1")));
        assertEquals(Term.of(BigRational.of("1/1")).add(Term.of(BigRational.of("2/1"))).eval(map),
    ...
    public void splice() {
        ...
        // (+ 1 2)
        position.add(1);
        assertEquals(Term.of(1).add(Term.of(2)).splice(position, Term.of(9)), Term.of(9).add(Term.of(2)));
    }
