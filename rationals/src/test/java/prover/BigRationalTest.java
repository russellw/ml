...
public class BigRationalTest {
    ...
    public void ofDecimal() {
        assertEquals(BigRational.ofDecimal("123"), BigRational.of(BigInteger.valueOf(123), BigInteger.ONE));
        assertEquals(BigRational.ofDecimal("+123"), BigRational.of(BigInteger.valueOf(123), BigInteger.ONE));
        assertEquals(BigRational.ofDecimal("-123"), BigRational.of(BigInteger.valueOf(-123), BigInteger.ONE));
        assertEquals(BigRational.ofDecimal("123.456"), BigRational.of(BigInteger.valueOf(123456), BigInteger.valueOf(1000)));
        assertEquals(BigRational.ofDecimal("123.456e3"), BigRational.of(BigInteger.valueOf(123456), BigInteger.valueOf(1)));
        assertEquals(BigRational.ofDecimal("123.456e-3"),
    ...
    public void parseFraction() {
        ...
        assertEquals(BigRational.of("+123/1"), BigRational.of(BigInteger.valueOf(123), BigInteger.ONE));
        assertEquals(BigRational.of("-123/1"), BigRational.of(BigInteger.valueOf(-123), BigInteger.ONE));
        assertEquals(BigRational.of("123/456"), BigRational.of(BigInteger.valueOf(123), BigInteger.valueOf(456)));
    }
}
