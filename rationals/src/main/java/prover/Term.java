...
public abstract class Term implements Iterable<Term> {
  ...
  public static final Term DIVIDE =
      new Term() {
        @Override
        public Op called() {
          return Op.DIVIDE;
  ...
  public static final Term DIVIDE_EUCLIDEAN =
      new Term() {
        @Override
        public Op called() {
  ...
  public static final Term DIVIDE_FLOOR =
      new Term() {
        @Override
        public Op called() {
  ...
  public static final Term DIVIDE_TRUNCATE =
      new Term() {
        @Override
        public Op called() {
  ...
  public static final Term EXISTS =
      new Term() {
        @Override
        public Op called() {
          return Op.EXISTS;
  ...
  public static final Term FLOOR =
      new Term() {
        @Override
        public Op called() {
          return Op.FLOOR;
  ...
  public static final Term IS_INTEGER =
      new Term() {
        @Override
        public Op called() {
  ...
  public static final Term IS_RATIONAL =
      new Term() {
        @Override
        public Op called() {
  ...
  public static final Term LESS_EQ =
      new Term() {
        @Override
        public Op called() {
          return Op.LESS_EQ;
  ...
  public static final Term MULTIPLY =
      new Term() {
        @Override
        public Op called() {
          return Op.MULTIPLY;
  ...
  public static final Term NEGATE =
      new Term() {
        @Override
        public Op called() {
          return Op.NEGATE;
  ...
  public static final Term REMAINDER_EUCLIDEAN =
      new Term() {
        @Override
        public Op called() {
  ...
  public static final Term REMAINDER_FLOOR =
      new Term() {
        @Override
        public Op called() {
  ...
  public static final Term REMAINDER_TRUNCATE =
      new Term() {
        @Override
        public Op called() {
  ...
  public static final Term ROUND =
      new Term() {
        @Override
        public Op called() {
          return Op.ROUND;
  ...
  public static final Term SUBTRACT =
      new Term() {
        @Override
        public Op called() {
          return Op.SUBTRACT;
  ...
  public static final Term TO_INTEGER =
      new Term() {
        @Override
        public Op called() {
  ...
  public static final Term TO_RATIONAL =
      new Term() {
        @Override
        public Op called() {
  ...
  public static final Term TO_REAL =
      new Term() {
        @Override
        public Op called() {
          return Op.TO_REAL;
  ...
  public static final Term TRUNCATE =
      new Term() {
        @Override
        public Op called() {
          return Op.TRUNCATE;
  ...
  public final Term deepSplice(int i, Term b) {
    ...
    for (var x : cdr()) {
      var j = x.deepSize();
      r.add(((n <= i) && (i < n + j)) ? x.deepSplice(i - n, b) : x);
      n += j;
    }
    return of(r);
  }
      ...
      case IF:
        {
          ...
          return (test == TRUE) ? get(2).eval(map) : get(3).eval(map);
        }
      case NOT:
        {
          var a = get(1).eval(map);
