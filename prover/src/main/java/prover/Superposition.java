...
public final class Superposition {
    ...
    private static void superposition(Clause c, Clause d, int ci, Term c0, Term c1, int di, Term d0, Term d1,
                                      List<Integer> position, Term a) {
    ...
    private static void superposition1(Clause c, Clause d, int ci, Term c0, Term c1, int di, Term d0, Term d1,
                                       List<Integer> position, Term a) {
        var map = new HashMap<Variable, Term>();
        if (!c0.unify(a, map)) {
            return;
        ...
        ((di < d.negativeSize)
         ? negative
         : positive).add(e.replace(map).term());
